 ...
 * @author sidb
 */
public class AdminOrgLeftPanel extends javax.swing.JPanel {

    /**
     * Creates new form OrgLeftPanel
     */
    public AdminOrgLeftPanel() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        INFO5100Project.getUI().ChangeRightPanel(new OrgMembersPage(), "OrgMembersPage");
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
                INFO5100Project.getUI().ChangeRightPanel(new OrgAddMembers(), "OrgAddMembers");
